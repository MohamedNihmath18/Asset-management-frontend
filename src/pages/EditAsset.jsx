      ...
      try {
        ...
        setFormData({
          ...
          warrantyStartDate: assetData.warrantyStartDate
            ? new Date(assetData.warrantyStartDate).toISOString().split("T")[0]
            : "",
          ppmStartDate: assetData.ppmStartDate
            ? new Date(assetData.ppmStartDate).toISOString().split("T")[0]
            : "",
          ppmEndDate: assetData.ppmEndDate
            ? new Date(assetData.ppmEndDate).toISOString().split("T")[0]
            : "",
          invoiceNo: assetData.invoiceNo || "",
          equipmentType: assetData.equipmentType || "critical",
          poNo: assetData.poNo || "",
